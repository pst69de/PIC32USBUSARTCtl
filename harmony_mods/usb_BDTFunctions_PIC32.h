...
PLIB_TEMPLATE uint8_t USB_BDTIndexGet( USB_PING_PONG_MODE ppMode,
                                uint8_t epValue,
...
/* Function :  USB_BufferIndexGet_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferIndexGet function.
*/

PLIB_TEMPLATE uint8_t USB_BufferIndexGet_PIC32( USB_MODULE_ID index , USB_PING_PONG_MODE ppMode , uint8_t epValue , USB_BUFFER_DIRECTION bufferDirection , USB_BUFFER_PING_PONG  bufferPingPong )
{
    return epValue*4 + bufferDirection*2 + bufferPingPong;
}
...
/* Function :  USB_BufferAddressGet_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferAddressGet function.
*/

PLIB_TEMPLATE void* USB_BufferAddressGet_PIC32( USB_MODULE_ID index , void* pBDT , USB_PING_PONG_MODE ppMode , uint8_t epValue , USB_BUFFER_DIRECTION bufferDirection , USB_BUFFER_PING_PONG  bufferPingPong )
{
...
/* Function :  USB_BufferAddressSet_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferAddressSet function.
*/

PLIB_TEMPLATE void USB_BufferAddressSet_PIC32( USB_MODULE_ID index , void* pBDT , USB_PING_PONG_MODE ppMode , uint8_t epValue , USB_BUFFER_DIRECTION bufferDirection , USB_BUFFER_PING_PONG  bufferPingPong , void* bufferAddress )
{
    short iBDTEntry; // Index of BDT entry
    pUSB_BDT_ENTRY pBDTEntry;
...
/* Function :  USB_BufferByteCountGet_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferByteCountGet function.
*/

PLIB_TEMPLATE uint16_t USB_BufferByteCountGet_PIC32( USB_MODULE_ID index , void* pBDT , USB_PING_PONG_MODE ppMode , uint8_t epValue , USB_BUFFER_DIRECTION bufferDirection , USB_BUFFER_PING_PONG  bufferPingPong )
{
    short iBDTEntry; // Index of BDT entry
    pUSB_BDT_ENTRY pBDTEntry;
...
/* Function :  USB_BufferByteCountSet_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferByteCountSet function.
*/

PLIB_TEMPLATE void USB_BufferByteCountSet_PIC32( USB_MODULE_ID index , void* pBDT , USB_PING_PONG_MODE ppMode , uint8_t epValue , USB_BUFFER_DIRECTION bufferDirection , USB_BUFFER_PING_PONG  bufferPingPong , uint16_t bufferByteCount )
{
    short iBDTEntry; // Index of BDT entry
    pUSB_BDT_ENTRY pBDTEntry;
...
/* Function :  USB_BufferClearAll_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferClearAll function.
*/

PLIB_TEMPLATE void USB_BufferClearAll_PIC32(USB_MODULE_ID index, void * pBDT,
...
/* Function :  USB_BufferDataToggleGet_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferDataToggleGet function.
*/

PLIB_TEMPLATE USB_BUFFER_DATA01 USB_BufferDataToggleGet_PIC32( USB_MODULE_ID index , void* pBDT , USB_PING_PONG_MODE ppMode , uint8_t epValue , USB_BUFFER_DIRECTION bufferDirection , USB_BUFFER_PING_PONG  bufferPingPong )
{
    short iBDTEntry; // Index of BDT entry
    pUSB_BDT_ENTRY pBDTEntry;
...
/* Function :  USB_BufferDataToggleSelect_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferDataToggleSelect function.
*/

PLIB_TEMPLATE void USB_BufferDataToggleSelect_PIC32( USB_MODULE_ID index , void* pBDT , USB_PING_PONG_MODE ppMode , uint8_t epValue , USB_BUFFER_DIRECTION bufferDirection , USB_BUFFER_PING_PONG  bufferPingPong , USB_BUFFER_DATA01 bufferData01 )
{
    short iBDTEntry; // Index of BDT entry
    pUSB_BDT_ENTRY pBDTEntry;
...
/* Function :  USB_BufferDataToggleSyncDisable_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferDataToggleSyncDisable function.
*/

PLIB_TEMPLATE void USB_BufferDataToggleSyncDisable_PIC32( USB_MODULE_ID index , void* pBDT , USB_PING_PONG_MODE ppMode , uint8_t epValue , USB_BUFFER_DIRECTION bufferDirection , USB_BUFFER_PING_PONG  bufferPingPong )
{
    short iBDTEntry; // Index of BDT entry
    pUSB_BDT_ENTRY pBDTEntry;
...
/* Function :  USB_BufferDataToggleSyncEnable_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferDataToggleSyncEnable function.
*/

PLIB_TEMPLATE void USB_BufferDataToggleSyncEnable_PIC32( USB_MODULE_ID index , void* pBDT , USB_PING_PONG_MODE ppMode , uint8_t epValue , USB_BUFFER_DIRECTION bufferDirection , USB_BUFFER_PING_PONG  bufferPingPong )
{
    short iBDTEntry; // Index of BDT entry
    pUSB_BDT_ENTRY pBDTEntry;
...
/* Function :  USB_BufferPIDBitsClear_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferPIDBitsClear function.
*/

PLIB_TEMPLATE void USB_BufferPIDBitsClear_PIC32( USB_MODULE_ID index , void* pBDT , USB_PING_PONG_MODE ppMode , uint8_t epValue , USB_BUFFER_DIRECTION bufferDirection , USB_BUFFER_PING_PONG  bufferPingPong )
{
    short iBDTEntry; // Index of BDT entry
    pUSB_BDT_ENTRY pBDTEntry;
...
/* Function :  USB_BufferPIDGet_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferPIDGet function.
*/

PLIB_TEMPLATE uint8_t USB_BufferPIDGet_PIC32( USB_MODULE_ID index , void* pBDT , USB_PING_PONG_MODE ppMode , uint8_t epValue , USB_BUFFER_DIRECTION bufferDirection , USB_BUFFER_PING_PONG  bufferPingPong )
{
    short iBDTEntry; // Index of BDT entry
    pUSB_BDT_ENTRY pBDTEntry;
...
/* Function :  USB_BufferReleasedToSW_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferReleasedToSW function.
*/

PLIB_TEMPLATE bool USB_BufferReleasedToSW_PIC32( USB_MODULE_ID index , void* pBDT , USB_PING_PONG_MODE ppMode , uint8_t epValue , USB_BUFFER_DIRECTION bufferDirection , USB_BUFFER_PING_PONG  bufferPingPong )
{
    short iBDTEntry; // Index of BDT entry
    pUSB_BDT_ENTRY pBDTEntry;
...
/* Function :  USB_BufferReleaseToUSB_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferReleaseToUSB function.
*/

PLIB_TEMPLATE void USB_BufferReleaseToUSB_PIC32( USB_MODULE_ID index , void* pBDT , USB_PING_PONG_MODE ppMode , uint8_t epValue , USB_BUFFER_DIRECTION bufferDirection , USB_BUFFER_PING_PONG  bufferPingPong )
{
    short iBDTEntry; // Index of BDT entry
    pUSB_BDT_ENTRY pBDTEntry;
...
/* Function :  USB_BufferSchedule_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferSchedule function.
*/


PLIB_TEMPLATE void USB_BufferSchedule_PIC32( USB_MODULE_ID  index ,
                                             void*  pBDT ,
                                             USB_PING_PONG_MODE  ppMode ,
                                             uint8_t  epValue ,
                                             USB_BUFFER_DIRECTION  bufferDirection ,
...
/* Function :  USB_BufferCancelReleaseToUSB_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferCancelReleaseToUSB function.
*/

PLIB_TEMPLATE void USB_BufferCancelReleaseToUSB_PIC32( USB_MODULE_ID index , void* pBDT , USB_PING_PONG_MODE ppMode , uint8_t epValue , USB_BUFFER_DIRECTION bufferDirection , USB_BUFFER_PING_PONG  bufferPingPong )
{
    short iBDTEntry; // Index of BDT entry
    pUSB_BDT_ENTRY pBDTEntry;
...
PLIB_TEMPLATE void USB_BufferAllCancelReleaseToUSB_PIC32( USB_MODULE_ID index , void* pBDT , USB_PING_PONG_MODE ppMode , int nEndpoint )
{
...
/* Function :  USB_BufferEP0RxStatusInitialize_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferEP0RxStatusInitialize function.
*/


PLIB_TEMPLATE void USB_BufferEP0RxStatusInitialize_PIC32 ( USB_MODULE_ID index,
                                            void* pBDT,
                                            USB_PING_PONG_MODE ppMode,
...
PLIB_TEMPLATE void USB_BufferClearAllDTSEnable_PIC32(USB_MODULE_ID index,
                                           void * pBDT,
                                           USB_PING_PONG_MODE ppMode,
                                           uint8_t epValue,
                                           USB_BUFFER_DIRECTION bufferDirection)
...
/* Function :  USB_BufferStallDisable_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferStallDisable function.
*/

PLIB_TEMPLATE void USB_BufferStallDisable_PIC32( USB_MODULE_ID index , void* pBDT , USB_PING_PONG_MODE ppMode , uint8_t epValue , USB_BUFFER_DIRECTION bufferDirection , USB_BUFFER_PING_PONG  bufferPingPong )
{
    short iBDTEntry; // Index of BDT entry
    pUSB_BDT_ENTRY pBDTEntry;
...
/* Function :  USB_BufferStallEnable_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferStallEnable function.
*/

PLIB_TEMPLATE void USB_BufferStallEnable_PIC32( USB_MODULE_ID index , void* pBDT , USB_PING_PONG_MODE ppMode , uint8_t epValue , USB_BUFFER_DIRECTION bufferDirection , USB_BUFFER_PING_PONG  bufferPingPong )
{
    short iBDTEntry; // Index of BDT entry
    pUSB_BDT_ENTRY pBDTEntry;
...
/* Function :  USB_BufferStallEnable_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_BufferStallGet function.
*/

PLIB_TEMPLATE bool USB_BufferStallGet_PIC32( USB_MODULE_ID index , void* pBDT , USB_PING_PONG_MODE ppMode , uint8_t epValue , USB_BUFFER_DIRECTION bufferDirection , USB_BUFFER_PING_PONG  bufferPingPong )
{
    short iBDTEntry; // Index of BDT entry
    pUSB_BDT_ENTRY pBDTEntry;
...
/* Function :  USB_ExistsBDTFunctions_PIC32
  ...
  Description:
    This template implements the PIC32 variant of the PLIB_USB_ExistsBDTFunctions function.
*/
