...
PLIB_TEMPLATE INT_SOURCE INT_VectorGet_Default( INT_MODULE_ID index )
{
    return(INT_SOURCE)(_SFR_FIELD_READ(_INT_LATEST_INT_VECTOR_VREG(index),_INT_LATEST_INT_VECTOR_MASK(index),_INT_LATEST_INT_VECTOR_POS(index)));
}
